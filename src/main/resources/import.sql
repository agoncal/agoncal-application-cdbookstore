-- CATEGORY
INSERT INTO CATEGORY (id, version, name) VALUES (1001, 1, 'Arts & Photography');
INSERT INTO CATEGORY (id, version, name) VALUES (1002, 1, 'Biographies & Memoirs');
INSERT INTO CATEGORY (id, version, name) VALUES (1003, 1, 'Business & Money');
INSERT INTO CATEGORY (id, version, name) VALUES (1004, 1, 'Comics & Graphic Novels');
INSERT INTO CATEGORY (id, version, name) VALUES (1005, 1, 'Computers & Technology');
INSERT INTO CATEGORY (id, version, name) VALUES (1006, 1, 'Cookbooks, Food & Wine');
INSERT INTO CATEGORY (id, version, name) VALUES (1007, 1, 'Engineering & Transportation');
INSERT INTO CATEGORY (id, version, name) VALUES (1008, 1, 'Health, Fitness & Dieting');
INSERT INTO CATEGORY (id, version, name) VALUES (1009, 1, 'Literature & Fiction');
INSERT INTO CATEGORY (id, version, name) VALUES (1010, 1, 'Mystery, Thriller & Suspense');
INSERT INTO CATEGORY (id, version, name) VALUES (1011, 1, 'Science & Math');
INSERT INTO CATEGORY (id, version, name) VALUES (1012, 1, 'Science Fiction & Fantasy');

-- GENRE
INSERT INTO GENRE (id, version, name) VALUES (1001, 1, 'Alternative Rock');
INSERT INTO GENRE (id, version, name) VALUES (1002, 1, 'Blues');
INSERT INTO GENRE (id, version, name) VALUES (1003, 1, 'Classical Music');
INSERT INTO GENRE (id, version, name) VALUES (1004, 1, 'Classic Rock');
INSERT INTO GENRE (id, version, name) VALUES (1005, 1, 'Country');
INSERT INTO GENRE (id, version, name) VALUES (1006, 1, 'Indie Music');
INSERT INTO GENRE (id, version, name) VALUES (1007, 1, 'Jazz');
INSERT INTO GENRE (id, version, name) VALUES (1008, 1, 'Latin Music');
INSERT INTO GENRE (id, version, name) VALUES (1009, 1, 'Pop');
INSERT INTO GENRE (id, version, name) VALUES (1010, 1, 'R&B');
INSERT INTO GENRE (id, version, name) VALUES (1011, 1, 'Reggae');
INSERT INTO GENRE (id, version, name) VALUES (1012, 1, 'Rock');
INSERT INTO GENRE (id, version, name) VALUES (1013, 1, 'Psychedelic');
INSERT INTO GENRE (id, version, name) VALUES (1014, 1, 'World Music');

-- LABEL
INSERT INTO LABEL (id, version, name) VALUES (1001, 1, 'Island');
INSERT INTO LABEL (id, version, name) VALUES (1002, 1, 'EMI');
INSERT INTO LABEL (id, version, name) VALUES (1003, 1, 'Sony');
INSERT INTO LABEL (id, version, name) VALUES (1004, 1, 'BMG');
INSERT INTO LABEL (id, version, name) VALUES (1005, 1, 'Universal Music Group');
INSERT INTO LABEL (id, version, name) VALUES (1006, 1, 'PolyGram');
INSERT INTO LABEL (id, version, name) VALUES (1007, 1, 'Apple');
INSERT INTO LABEL (id, version, name) VALUES (1008, 1, 'Parlophone');

-- PUBLISHER
INSERT INTO PUBLISHER (id, version, name) VALUES (1001, 1, 'Pearson');
INSERT INTO PUBLISHER (id, version, name) VALUES (1002, 1, 'Hachette Livre');
INSERT INTO PUBLISHER (id, version, name) VALUES (1003, 1, 'Wiley');
INSERT INTO PUBLISHER (id, version, name) VALUES (1004, 1, 'Oxford University Press');
INSERT INTO PUBLISHER (id, version, name) VALUES (1005, 1, 'Harlequin');
INSERT INTO PUBLISHER (id, version, name) VALUES (1006, 1, 'Flammarion');
INSERT INTO PUBLISHER (id, version, name) VALUES (1007, 1, 'Groupe Gallimard');
INSERT INTO PUBLISHER (id, version, name) VALUES (1008, 1, 'APress');
INSERT INTO PUBLISHER (id, version, name) VALUES (1009, 1, 'O Reilly');
INSERT INTO PUBLISHER (id, version, name) VALUES (1010, 1, 'Pottermore');

-- AUTHOR
INSERT INTO AUTHOR (id, version, first_name, last_name, preferred_language, bio) VALUES (1001, 1, 'Nigel', 'Deakin', 1, 'Nigel Deakin is specification lead for JMS 2.0 (JSR 343) and a principal member of technical staff at Oracle.');
INSERT INTO AUTHOR (id, version, first_name, last_name, preferred_language, bio) VALUES (1002, 1, 'Fred', 'Rowe', 1, 'Fred is the WebSphere Architect for a number of Application Server components including those responsible for JEE managed concurrency, JCA (Java Connector Architecture), and database connectivity and connection management. Fred has worked at IBM for 10...');
INSERT INTO AUTHOR (id, version, first_name, last_name, preferred_language, bio) VALUES (1003, 1, 'Kinman', 'Chung', 1, 'Spec lead for JSR 341, EL 3.0. Formerly a Tomcat committer. Currently a developer in Glassfish, working on web container, JSP and EL.');
INSERT INTO AUTHOR (id, version, first_name, last_name, preferred_language) VALUES (1004, 1, 'Linda', 'Demichiel', 1);
INSERT INTO AUTHOR (id, version, first_name, last_name, preferred_language, bio) VALUES (1005, 1, 'Arun', 'Gupta', 1, 'Arun Gupta is a Java evangelist working at Oracle. He works to create and foster the community around Java EE, GlassFish, and WebLogic. He has been with the Java EE team since its inception and contributed to all releases. Arun has extensive world wide...');
INSERT INTO AUTHOR (id, version, first_name, last_name, preferred_language, bio) VALUES (1006, 1, 'Lincoln', 'Baxter III', 1, 'Lincoln Baxter, III is a Research Engineer at Red Hat, working on JBoss open-source projects; most notably as project lead for JBoss Forge.');
INSERT INTO AUTHOR (id, version, first_name, last_name, preferred_language, bio) VALUES (1007, 1, 'Ed', 'Burns', 1, 'Ed Burns is a Senior Staff Engineer for Oracle Corporation where he chairs the JSR 344 (JSF 2.2) Expert Group and contributes to the open source Mojarra project. He is the author of two books published by McGraw-Hill: Secrets of the Rock Star Programme...');
INSERT INTO AUTHOR (id, version, first_name, last_name, preferred_language, bio) VALUES (1008, 1, 'Roger', 'Kitain', 1, 'Roger Kitain is an Engineer at Oracle Corporation where he spent the last 15 years working with web technologies. He started working on JavaServer Faces in 2001 as a member of the implementation team and has co-led the specification for JSF since 1.1, ...');
INSERT INTO AUTHOR (id, version, first_name, last_name, preferred_language, bio) VALUES (1009, 1, 'Antonio', 'Goncalves', 0, 'Antonio is a senior developer specialized in Java/Java EE. As a consultant he advises customers and helps them in defining and developing their software architecture. This Java Champion is also the founder of the very successful Paris JUG, Devoxx Franc...');
INSERT INTO AUTHOR (id, version, first_name, last_name, preferred_language, bio) VALUES (1010, 1, 'Adam', 'Bien', 6, 'Consultant and author Adam Bien is an Expert Group member for the Java EE 6 / 7, EJB 3.X, JAX-RS and JPA 2.X JSRs. He has worked with Java technology since JDK 1.0 and with Servlets/EJB 1.0 and is now an architect and developer for Java SE and Java EE ...');
INSERT INTO AUTHOR (id, version, first_name, last_name, preferred_language, bio) VALUES (1011, 1, 'Emmanuel', 'Bernard', 0, 'Emmanuel Bernard is data platform architect at JBoss by Red Hat where he oversees data projects of the Red Hat''s middleware and is member of the Hibernate team. Emmanuel has spent a few years in the retail industry as developer and architect where he ...');
INSERT INTO AUTHOR (id, version, first_name, last_name, preferred_language, bio) VALUES (1012, 1, 'Jitendra', 'Kotamraju', 1, 'Jitendra Kotamraju is a software engineer at Oracle. He has been contributing to the many Java EE technologies and GlassFish projects for the last 8 years. He was the specification and implementation lead of JAX-WS 2.2. At present, he is the specificat...');
INSERT INTO AUTHOR (id, version, first_name, last_name, preferred_language, bio) VALUES (1013, 1, 'Mike', 'Keith', 1, 'Mike Keith has been an enterprise, distributed systems and persistence expert for over 20 years. He is a Java and Enterprise Architect at Oracle and contributes to Java EE and many of the subspecifications that make up the enterprise Java portfolio. He...');
INSERT INTO AUTHOR (id, version, first_name, last_name, preferred_language, bio) VALUES (1014, 1, 'Anthony', 'Lai', 1, 'Anthony Lai is a principal member of technical staff at Oracle. He is the specification lead for JSR 236 - Concurrency Utilities for Java EE 1.0, and was previously a member of the J2EE Connector Architecture 1.5 specification (JSR 112) expert group.');
INSERT INTO AUTHOR (id, version, first_name, last_name, preferred_language, bio) VALUES (1015, 1, 'J. K.', 'Rowling', 1, 'J K (Joanne Kathleen) Rowling was born in the summer of 1965 at Yate General Hospital in England and grew up in Chepstow, Gwent where she went to Wyedean Comprehensive. Jo left Chepstow for Exeter University, where she earned a French and Classics degree, and where her course included one year in Paris');
...
-- CD_MUSICIAN
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1013, 1001);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1013, 1002);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1013, 1003);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1013, 1004);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1014, 1001);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1014, 1002);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1014, 1003);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1014, 1004);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1015, 1001);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1015, 1002);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1015, 1003);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1015, 1004);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1016, 1001);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1016, 1002);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1016, 1003);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1016, 1004);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1017, 1001);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1017, 1002);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1017, 1003);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1017, 1004);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1017, 1005);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1017, 1006);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1018, 1009);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1018, 1010);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1018, 1011);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1018, 1012);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1019, 1009);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1019, 1010);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1019, 1011);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1019, 1012);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1020, 1009);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1020, 1010);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1020, 1011);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1020, 1012);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1021, 1009);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1021, 1010);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1021, 1011);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1021, 1012);
INSERT INTO ITEM_MUSICIAN (item_id, musicians_id) VALUES (1021, 1013);
